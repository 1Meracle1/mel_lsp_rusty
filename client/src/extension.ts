...
export async function activate(context: ExtensionContext) {
  ...
  const traceOutputChannel = window.createOutputChannel("Mel Language Server trace");
  const command = process.env.SERVER_PATH || "mel-language-server";
  ...
  client = new LanguageClient("mel-language-server", "mel language server", serverOptions, clientOptions);
